...
const SYSTEM_NOTICE_MOCK = [
    {
        ...
        content:
            "FryDay는 할 일을 ‘튀김’에 비유해, 미루지 않고 정해진 시간 안에 완료하도록 도와주는 투두 서비스예요.",
    },
    {
        title: "튀김은 어떻게 튀기나요?",
        content:
            "매일 00시, 새로운 할 일을 추가하면 튀김 반죽이 생성돼요.\n24시간 안에 할 일을 완료하면 바삭한 튀김이 완성되고, 시간 안에 완료하지 못하면 튀김이 까맣게 타 버린답니다.",
    },
    {
        title: "카테고리는 어디서 관리하나요?",
        content:
            "FryDay에서는 최대 6개의 카테고리를 사용할 수 있어요!\n홈 화면에 빈 자리가 있으면 새 카테고리 버튼으로 추가할 수 있고,\n카테고리가 6개 모두 찬 경우에는 홈 화면 우측 상단 버튼을 통해 카테고리 관리 페이지로 이동할 수 있어요.\n이 페이지에서 카테고리 순서 변경, 이름 수정, 삭제가 가능해요.",
    },
    {
        title: "투두를 수정할 수 있나요?",
        content:
